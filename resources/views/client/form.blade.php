        ...
        <div class="row">
            <div class="col-lg-12 mb-4 form-style">
                <div class="form-group train-deet">
                    ...
                    <div class="input-error">
                        <input class="form-control " id="company_name" type="text" name="company_name"
                            placeholder="Company Name" data-id="{{ isset($model->id) ? $model->id : '' }}"
                            value="{{ isset($model->company_name) ? $model->company_name : '' }}"
                            aria-describedby="login-company_name" autofocus="" />
                ...
                <div class="form-group train-deet">
                    ...
                    <div class="input-error">
                        <input class="form-control" id="address_one" type="text" name="address_one"
                            placeholder="Address" value="{{ isset($model->address_one) ? $model->address_one : '' }}"
                            aria-describedby="login-address_one" autofocus="" />
                        @error('address_one')
                            <span class="invalid-feedback" style="display: block;" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="form-group train-deet">
                    ...
                    <div class="input-error">
                        <input class="form-control" id="address_tow" type="text" name="address_tow"
                            placeholder="Address" value="{{ isset($model->address_tow) ? $model->company_name : '' }}"
                            aria-describedby="login-address_tow" autofocus="" />
                        @error('address_tow')
                            <span class="invalid-feedback" style="display: block;" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="form-group train-deet">
                    ...
                    <div class="input-error">
                        <input class="form-control" id="town" type="text" name="town" placeholder="Town"
                            value="{{ isset($model->town) ? $model->town : '' }}" aria-describedby="login-town"
                            autofocus="" />
                        @error('town')
                            <span class="invalid-feedback" style="display: block;" role="alert">
                                <strong>{{ $message }}</strong>
                                ...
                                @foreach ($countries as $key => $country)
                                    @if ($action == 'add')
                                        <option value="{{ $country->id }}"
                                            {{ $country->id == '230' ? 'selected' : '' }}>{{ $country->name }}
                                        </option>
                                    @else
                                        <option value="{{ $country->id }}"
                                            {{ $country->id == $model->country ? 'selected' : '' }}>
                                            {{ $country->name }}</option>
                                    @endif
                                @endforeach
                            @endif
                ...
                <div class="form-group train-deet">
                    ...
                    <div class="input-error">
                        <input class="form-control" id="post_code" type="text" name="post_code"
                            placeholder="Post Code" value="{{ isset($model->post_code) ? $model->post_code : '' }}"
                            aria-describedby="login-post_code" autofocus=""
                ...
                <div class="form-group train-deet">
                    ...
                    <div class="input-error">
                        <textarea class="form-control" id="notes" type="text" name="notes" rows="3" cols="50"
                            placeholder="Describe yourself here...">{{ isset($model->notes) ? $model->notes : '' }} </textarea>
