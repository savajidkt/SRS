<div class="multisteps_form_panel step sub-card">
	...
	<div class="text-primary mt-3"><strong>Change the order of the responses below from what you would most likely do to what you would least likely do in this scenario.</strong></div>
    <div class="card-body">
