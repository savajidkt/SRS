    ...
    <div class="row">
      <div class="col-lg-12 question-card">
        <div class="card">
          ...
          <div class="question-listing demo-survey" id="question-listing">
            <div class="multisteps_form_panel step sub-card">
              <p style="color: red;">Complete this practice scenario and click the "Begin Assessment" button.</p>
              <h5 class="card-header">You are a leader of an IT helpdesk response team, where your team's primary duties are to help employees with various technical challenges. Recently, your manager told you that they are leaving the company soon, and you are ready to be promoted into a managerial role. In preparation of this, there will be three interviews with other senior leaders. What would you do?</h5>
                  ...
                  <div class="col-lg-10">
                    <div id="sorting-list">
                      ...
                      <div class="customRadio-sec">
                        <div class="customRadio">
                        <input type="hidden" class="options" name="options[]" value="">
                          <label for="radio1">Research the other candidates so you know about your competition.</label>
                        </div>
                      </div>
                      <div class="customRadio-sec">
                        <div class="customRadio">
          ...
          <div class="row mt-4">
            ...
            <div class="col-lg-3 text-right b-btn-sec">
              ...
              <button type="button" class="btn btn-transparent r-btn" id="nextBtn" onclick="startSurvey()">Begin Assessment <img src="{{asset('front/assets/img/r-g-arrow.png')}}" alt="arrow"></button>
            </div>
          </div>
        </div>
      </div>
