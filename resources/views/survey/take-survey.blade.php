                ...
                <div class="card">
                    ...
                    <div class="progress">
                        ...
                        <div class="col-lg-3 text-right b-btn-sec">
                            ...
                            <button type="button" class="btn btn-transparent r-btn" id="nextBtn" onclick="nextPrev(1)">Next Question <img src="{{asset('front/assets/img/r-g-arrow.png')}}" alt="arrow"></button>
                        </div>
                    </div>
                </div>
            </div>
