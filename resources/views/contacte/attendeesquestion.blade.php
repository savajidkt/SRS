            ...
            <div class="card-body scrollspy-example">
              <table class="table table-striped table-bordered">
                ...
                <tbody>
                  <tr>
                    <th>
                      1) I am able to tell others how I am feeling about a
                      situation
                    </th>
                    <td>
                      <label class="form-check-custom">
                        <input type="radio" name="radio-21" />
                        <span>0</span>
                      </label>
                    </td>
                    <td>
                  ...
                  <tr>
                    <th>
                      2) I regularly give feedback to others on what I like or
                      don't like
                    </th>
                    <td>
                      <label class="form-check-custom">
                  ...
                  <tr>
                    <th>
                      3) I respond to an argument by restating the facts and
                      logic of my case
                    </th>
                    <td>
                      <label class="form-check-custom">
                  ...
                  <tr>
                    <th>
                      4) I use questions to help others explore their ideas
                    </th>
                    <td>
                      <label class="form-check-custom">
                        <input type="radio" name="radio-21" />
                  ...
                  <tr>
                    <th>
                      5) I find it easy to talk to people about my experiences
                    </th>
                    <td>
                      <label class="form-check-custom">
                        <input type="radio" name="radio-21" />
                  ...
                  <tr>
                    <th>6) I like to help others think 'big picture'</th>
                    <td>
                      <label class="form-check-custom">
                        <input type="radio" name="radio-21" />
                        <span>0</span>
                  ...
                  <tr>
                    <th>
                      7) I can anticipate how I am likely to react in most
                      situations
                    </th>
                    <td>
                      <label class="form-check-custom">
                  ...
                  <tr>
                    <th>8) I find it easy to describe my feelings</th>
                    <td>
                      <label class="form-check-custom">
                        <input type="radio" name="radio-21" />
                        <span>0</span>
                  ...
                  <tr>
                    <th>
                      9) I am comfortable telling people clearly and concisely
                      what I want or need
                    </th>
                    <td>
                      <label class="form-check-custom">
                  ...
                  <tr>
                    <th>
                      10) I frequently have more facts than I need to back up my
                      case
                    </th>
                    <td>
                      <label class="form-check-custom">
