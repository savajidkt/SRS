...
<body>
                ...
                <div class="card">
                    ...
                    @if ($ext_id == '360-frm')
                        <div class="card-body myExistdiv">
                            ...
                            <p class="card-text attendee-home-font">You already added 1 contact. if you do not want to
                                add more then you can skip this step.
                            </p>
                            <div class="btn-grp">
                                <a href="{{ route('attendees-questionnaire', [$id, $at_id]) }}"
                                    class="btn btn-primary mySkepBTN">Skip this step</a>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="basic-form">
                                    ...
                                    <form class="contacte-repeater" action="{{ route('store-contacte') }}"
                                                        ...
                                                        <div class="form-group col-md-6 form-gap-2">
                                                            ...
                                                            <div class="input-error">
                                                                <input type="email" class="form-control"
                                                                    name="email" placeholder="" id="email_0"
                                                                    email-id="email">
                                                            </div>
                                                        </div>
                                                        <div class="form-group col-md-6 form-gap-2">
                                                            <label>Confirm Email Address<span
                                                                    class="filedrequired">*</span></label>
                                                            <div class="input-error">
                                                                <input type="email" class="form-control"
                                                                    name="confirm_email" placeholder=""
                                                                    id="confirm_email_0"
                                                                    confirm-email-id="confirm_email">
                                                            </div>
                                                        </div>
                                                        <div class="form-group col-md-6 form-gap-2">
    ...
    <script type="text/javascript">
        function startTime() {
            ...
            var suffixes = ['', 'st', 'nd', 'rd', 'th', 'th', 'th', 'th', 'th', 'th', 'th', 'th', 'th', 'th', 'th', 'th',
                'th', 'th', 'th', 'th', 'th', 'st', 'nd', 'rd', 'th', 'th', 'th', 'th', 'th', 'th', 'th', 'st', 'nd',
                'rd'
            ];
            ...
            document.getElementById('demo').innerHTML = (weekday[today.getDay()] + ',' + " " + today.getDate() + '<sup>' +
                suffixes[today.getDate()] + '</sup>' + " " + month[today.getMonth()] + " " + today.getFullYear() +
