                                            ...
                                            <div data-repeater-item>
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6 form-gap-2">
                                                        <label class="text-label">Your Job Title</label>
                                                        <div class="input-error">
                                                        <select class="form-select form-select-sm select2" data-minimum-results-for-search="Infinity" name="job_title" id="form-select-sm-attendee-1" aria-label=".form-select-sm example">
