...
class pDraw
{
  ...
  function drawScale($Format = "")
  {
    ...
    $RemoveXAxis  = isset($Format["RemoveXAxis"]) ? $Format["RemoveXAxis"] : true;
  ...
  function drawXThreshold($Value, $Format = "")
  {
    ...
    $CaptionSettings = array(
      "DrawBox" => $DrawBox, "DrawBoxBorder" => $DrawBoxBorder, "BorderOffset" => $BorderOffset, "BoxRounded" => $BoxRounded, "RoundedRadius" => $RoundedRadius,
