...
class Course extends Model
{
    ...
    {
        return $this->hasMany(ClientContact::class,'course_id','id');
    }
    ...
    public function getActionAttribute(): string
    {
        ...
        // $editAction = '<a href="'. route('course.edit', $this->id).'"><i class="fa-regular fa-pen-to-square edit-ico" title="Edit"></i></a> ';
        // $viewAction = '<a href="'. route('course.show', $this->id).'"><i class="fa-solid fa-eye" title="View"></i></a> ';
        // $deleteAction = '<a href="'.route('course.destroy', $this).'" class="delete_action" data-method="delete"><i class="fa-sharp fa-solid fa-xmark" title="Remove"></i></a>';
